        ...
        >
          ...
          >
            <Box p={5}>
              Сделать:
              <ul>
                <li>Добавь фильтр через then что бы id отображалась</li>
                <li>Сделать что бы можно было добавлять новые места сразу в БД + изменять старые</li>
                <li>Картинки положилть в Storage firebase</li>
